...
train_dataset = GeoMat(
    path, True, transform, pre_transform, feature_extraction="v5", img_model=img_model
)
test_dataset = GeoMat(
    path, False, transform, pre_transform, feature_extraction="v5", img_model=img_model
)
